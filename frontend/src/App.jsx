...
const App = () => {
    ...
    const fetchConversation = async () => {
      ...
      if (conversationId) {
        const response = await fetch(
          `http://srv-alacran--service2-chatbot/service2/${conversationId}`
        );
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/images/background.webp')`,
        backgroundSize: "cover",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
      }}
    >
      <h1 className="text-3xl font-bold mb-4 text-white">Chatbot</h1>
